    ...
    return (
        <div className="hero min-h-screen bg-secondary">
            ...
            <div className="hero-content  flex-col lg:flex-row-reverse">
                <div>
                    <h1 className="text-3xl text-center uppercase text-accent font-bold my-2">Million Business trust BD</h1>
                    <h1 className="text-xl uppercase text-center pb-16 font-bold">Try to understand user expectation</h1>
                    <Summary></Summary>
                    <div className="card my-3 bg-base-100 lg:card-side shadow-xl">
